...
function processService(edmxFile, config, targetFolderPath) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var _a, _b, _c, entityName, entityConfig, e_2_1;
        var e_2, _d;
        return tslib_1.__generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, entitySet_1.generateEntitySet(edmxFile, entityName, entityConfig, targetFolderPath, config.baseUrl)];
                case 3:
                    _e.sent();
                    _e.label = 4;
                case 4:
                ...
                case 7:
                    ...
                    return [7 /*endfinally*/];
                case 8: return [4 /*yield*/, metadataFile_1.generateMetadataFile(edmxFile, outputDirectory)];
                case 9:
                    _e.sent();
                    return [2 /*return*/];
            }
