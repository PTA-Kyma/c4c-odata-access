...
var C4CService = /** @class */ (function () {
    ...
    C4CService.prototype.ensureCsrfToken = function (text) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.axios.defaults.headers['X-CSRF-Token'] === 'fetch')) return [3 /*break*/, 2];
    ...
    C4CService.prototype.patch = function (text, obj) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ensureCsrfToken(text)];
                    case 1:
                        _a.sent();
